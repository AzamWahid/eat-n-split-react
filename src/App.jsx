  ...
  return (
    <>
      <div style={{ display: 'flex' }}>
        <div>
          <FriendList friendList={friendList} isSelected={isSelected} setIsSelected={setIsSelected} />
          <AddFriendForm friendList={friendList} setFriendList={setFriendList} />
        </div>
        <div>
          {(typeof isSelected === 'number' && isSelected >= 0) && < SplitExp friendList={friendList} isSelected={isSelected} />}
        </div>
      </div>
